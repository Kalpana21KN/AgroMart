...
<html lang="en">
	...
	<body >
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center" style="background-image:url(crops.png);background-size:cover;">
				<div class="container">
					<form method="POST" action="uploadProduct.php" enctype="multipart/form-data">
						<h2>Enter the Product Information here..!!</h2>
						<br>
				<center>
					<input type="file" name="productPic" style="background:transparent;color: black;font-weight:400"></input>
					<br />
				</center>
				<div class="row">
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  ...
								  <option value="Grains" style="color: black;">Grains and pulses</option>
