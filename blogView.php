...
<html>
	...
	<body class="subpage" style="background-image:url(bview.jpg);">
		...
		?>
			...
			<section id="main" class="wrapper" >
				<div class="inner">
					...
					<br />
					<div class="mybvid">
						<h3>This week special Blog from Agro Mart<h3>
							<h5>#please put the video here</h5>
					<iframe  style="width: 1030px; height:500px; border-radius:12px;" src="#add video link" autoplay="fales" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen controls muted></iframe>
					</div>
					<?php
						while($row = $result->fetch_array()) :
							$id = $row['blogId'];
					...
					<div class="box">
						...
						?>
							<div class="con darker"  style="color:black">
								<img src="<?php echo 'images/profileImages/'.$row1['commentPic']?>" alt="Avatar" height="200px" width="200px" style="border-radius:50%"><span  style="color:black"><em><?= $row1['commentUser']; ?></em></span>
								<br>
								<?= $row1['comment']; ?>
								<span class="time-right" style="color:black"><?= formatDate($row1['commentTime']); ?></span>
							</div>
