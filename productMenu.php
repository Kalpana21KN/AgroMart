...
<html lang="en">
	...
	<body class>
		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" style="background-image:linear-gradient( rgba(151, 149, 147, 0.6), rgba(157, 156, 153, 0.6)),url(menu.jpg);background-size:cover;background-repeat:no-repeat;">
				<div class="container">
				...
				?>
					<h3 style="color:white">Select Filter</h3>
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="grain" style="color: black;">Grains & pulses</option>
				...
				<?php
					...
					if(isset($_GET['type']) AND $_GET['type'] == "flowers")
					{
