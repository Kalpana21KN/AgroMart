...
<body>
				...
				<?php
					...
					?>
				<section id="main" class="wrapper style1 align-center" style="background-image:linear-gradient( rgba(151, 149, 147, 0.3), rgba(157, 156, 153, 0.3)),url(re.jpg);background-size:cover;background-repeat:no-repeat;">
						<div class="container">
							<div class="row">
								<div class="col-sm-4">
