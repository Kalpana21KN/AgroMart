...
<body>
    ...
    <section id="main" class="wrapper" style="background-image:linear-gradient( rgba(0, 0, 0, 0.75), rgba(0,0,0,0.75)),url(bas1.jpg);background-size:cover;background-repeat:no-repeat;" >
        <div class="container">
        <center>
        ...
        <div class="container">
            <center>
                <form method="post" action="buyNow.php?pid=<?= $pid; ?>" style="border: 2px solid black;border-radius:12px; padding: 15px;backdrop-filter: blur(10px);">
                    <center>
